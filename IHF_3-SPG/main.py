...
def main(SERIAL_NUMBER_CONTAINER):
    global FL_STATUS, PREV_FL_STATUS, gl_spg_heating_list, gl_ihf_heating_list, gl_oxygen_heating_list, gl_png_pressure_list, gl_air_pressure_list, gl_DAAcetylenePressure_list
    while True:
        serial_ = None
        ob_db = DBHelper()
